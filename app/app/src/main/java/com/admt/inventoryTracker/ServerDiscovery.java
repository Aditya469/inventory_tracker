...
public class ServerDiscovery {
    ...
    private static final String DISCOVERY_REQUEST_MESSAGE = "DISCOVER_INV_SERVER_REQUEST";
    private static final String DISCOVERY_RESPONSE_MESSAGE = "DISCOVER_INV_SERVER_RESPONSE";
